    ...
    >
      {item && (
        <>
                ...
                {admin && (
                  <>
                    ...
                    <FormControlLabel
                      ...
                      label={t('userAdmin')}
                      disabled={!admin || currentUser.support}
                    />
                    <FormControlLabel
                      control={<Checkbox checked={item.support} onChange={(e) => setItem({ ...item, support: e.target.checked })} />}
                      label={t('userSupport')}
                      disabled={currentUser.support}
                    />
                    <FormControlLabel
          ...
          {registrationEnabled && item.id === currentUser.id && !manager && admin && (
            <Accordion>
              <AccordionSummary expandIcon={<ExpandMoreIcon />}>
